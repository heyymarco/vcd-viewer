        ...
        >
{
    ...
    // components:
    editorComponent   : React.ReactComponentElement<any, EditorProps<Element, React.ChangeEvent<HTMLInputElement>, ValueOfModel<TModel>>>
...
const SimpleEditModelDialog = <TModel extends Model>(props: SimpleEditModelDialogProps<TModel>): JSX.Element|null => {
    ...
    // stores:
    const isCommiting = isCommitingExternal;
    ...
    const handleSave           = useEvent(async () => {
        ...
        try {
            const updatingModelTask : Promise<TModel> = Promise.resolve<TModel>({...model, [edit]: editorValue });
    ...
    const handleChangeInternal = useEvent<EditorChangeEventHandler<React.ChangeEvent<HTMLInputElement>, ValueOfModel<TModel>>>((value) => {
        ...
        <AccessibilityProvider enabled={!isLoading}>
            ...
            >
                <CardBody className={styleSheet.main}>
                    ...
                    >
                        {React.cloneElement<EditorProps<Element, React.ChangeEvent<HTMLInputElement>, ValueOfModel<TModel>>>(editorComponent,
                            // props:
                            {
